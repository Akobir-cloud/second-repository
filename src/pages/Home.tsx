...
import { fetchHeader, setHeader } from '../store/headerSlice';
...
const [formData, setFormData] = useState({
  ...
  const handleSave = async () => {
    try {
      ...
      const res = await fetch("http://localhost:3000/testDriveUsers", {
        method: "POST",
        headers: {
  ...
  // Formani yuborishni to'xtatib turish uchun
  ...
  return (
    <div className="antialiased overflow-x-hidden">
      ...
      {/* BEGIN: NavigationBar */}
      {/* TEPADAN TUSHISH ANIMATSIYASI VA PREMIUM ORQA FON */}
      <nav 
        data-aos="fade-down" 
      ...
      >
       ...
       {header.videoUrl && (
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-kia-dark to-transparent"></div>
        <div className="absolute inset-0 bg-gradient-to-r from-kia-dark via-transparent to-transparent"></div>
        ...
        <div className="relative z-10 max-w-2xl w-full" data-aos="fade-right" data-aos-duration="1000">
          ...
          <h1 className="text-white text-5xl md:text-7xl font-bold italic">
          {header.title}
        </h1>
      ...
      <main className="bg-kia-dark px-4 md:px-12 py-12 md:py-16 space-y-10 md:space-y-12">
              ...
              <SwiperSlide>
                <div className="bg-kia-card rounded-2xl overflow-hidden group border border-white/5 hover:border-white/20 transition-all duration-500 cursor-pointer h-full flex flex-col">
                  <div className="relative h-48 sm:h-56 overflow-hidden">
                    ...
                    <div className="absolute inset-0 bg-gradient-to-t from-kia-card via-kia-card/20 to-transparent"></div>
                  </div>
        ...
        <section data-aos="fade-up" className="max-w-7xl mx-auto bg-kia-card rounded-xl overflow-hidden border border-white/5 flex flex-col md:flex-row">
          <div className="md:w-3/5">
            <img alt="Kia Sonet in Bukhara" className="w-full h-full object-cover min-h-[250px] sm:min-h-[350px] md:min-h-[400px]" src="./sonet.svg"/>
          </div>
          <div className="md:w-2/5 p-6 sm:p-10 flex flex-col justify-center bg-gradient-to-br from-kia-card to-kia-dark">
        ...
        <section id="test-drive" className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6 sm:gap-8 items-center border-t border-white/10 pt-12 md:pt-20">
          <div data-aos="fade-right" className="w-full md:w-1/2 rounded-xl overflow-hidden">
            <img alt="Test Drive" className="w-full h-[250px] sm:h-[400px] md:h-[500px] object-cover" src="./nimadir.svg"/>
          </div>
...
/>
  ...
  onChange={handleChange}
>
                <option className="text-gray-500" disabled value="">Mashina modelini tanlang</option>
                <option className="text-black" value="k3">Kia K3</option>
                <option className="text-black" value="k5">Kia K5</option>
                <option className="text-black" value="ev9">Kia EV9</option>
              </select>
              <textarea
  name="comment"
  className="w-full bg-white/5 border border-white/10 rounded px-4 py-3 text-xs sm:text-sm focus:outline-none focus:border-white/30 text-white placeholder-gray-500 resize-none"
  placeholder="Izoh (ixtiyoriy)"
  rows={3}
  value={formData.comment}
  onChange={handleChange}
/>
              <button onClick={handleSave} className="w-full bg-white text-black py-4 text-xs sm:text-sm font-bold hover:bg-gray-200 transition-colors uppercase mt-2 sm:mt-4 tracking-wider rounded-md" type="button">
                YUBORISH
              </button>
            </form>
          </div>
        ...
        <section className="max-w-7xl mx-auto px-0 sm:px-6 py-16 md:py-24">
          ...
          <div className="relative overflow-hidden rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 backdrop-blur-xl shadow-2xl grid grid-cols-1 md:grid-cols-3">
            ...
            <div className="md:col-span-2 relative h-[300px] sm:h-[400px] md:h-[500px]">
              ...
              ></iframe>
              <div className="absolute inset-0 bg-gradient-to-t from-[#081520] via-transparent to-transparent pointer-events-none"></div>
      ...
      {/* BEGIN: Footer */}
      <footer className="bg-[#080B14] pt-12 md:pt-16 pb-6 md:pb-8 border-t border-white/5 text-sm">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 mb-10 md:mb-12">
            <div className="space-y-4">
              <div className="font-bold text-2xl sm:text-3xl tracking-widest mb-4 md:mb-6">
                <i><strong className="text-white"><img src="" alt="" /><img src={icon} alt="" /></strong></i>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 md:space-y-3 text-gray-400 text-xs sm:text-sm">
                <li><Link to="/models" className="hover:text-white transition-colors">Barcha modellar</Link></li>
                <li><Link to="/offers" className="hover:text-white transition-colors">Maxsus takliflar</Link></li>
            ...
            <div>
              ...
              <ul className="space-y-2 md:space-y-3 text-gray-400 text-xs sm:text-sm">
                <li><Link to="/services" className="hover:text-white transition-colors">Texnik xizmat ko'rsatish</Link></li>
                <li><Link to="/services" className="hover:text-white transition-colors">Ehtiyot qismlar</Link></li>
                <li><Link to="/services" className="hover:text-white transition-colors">Kafolat</Link></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2 md:space-y-3 text-gray-400 text-xs sm:text-sm">
                ...
                <li><Link to="/contact" className="hover:text-white transition-colors">Kontaktlar</Link></li>
              </ul>
            </div>
          </div>
